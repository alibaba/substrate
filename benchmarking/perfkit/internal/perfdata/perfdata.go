...
type LifecycleEvent struct {
	...
	HTTPIdempotencyKey    string `json:"http_idempotency_key,omitempty"`
	HTTPStale             bool   `json:"http_stale,omitempty"`
	HTTPCounter           int64  `json:"http_counter,omitempty"`
	HTTPStateVersion      int64  `json:"http_state_version,omitempty"`
	HTTPLastMutationID    string `json:"http_last_mutation_id,omitempty"`
	HTTPInstanceID        string `json:"http_instance_id,omitempty"`
	HTTPBootID            string `json:"http_boot_id,omitempty"`
	HTTPPodName           string `json:"http_pod_name,omitempty"`
	HTTPNodeName          string `json:"http_node_name,omitempty"`
	HTTPRouteGeneration   int64  `json:"http_route_generation,omitempty"`
	HTTPRoutePhase        string `json:"http_route_phase,omitempty"`
	HTTPRouteTargetWorker string `json:"http_route_target_worker,omitempty"`
	HTTPRouteTargetNode   string `json:"http_route_target_node,omitempty"`
	HTTPRouteTargetIP     string `json:"http_route_target_ip,omitempty"`
	...
	MaxRequestStartGapMS                           int64                             `json:"max_request_start_gap_ms,omitempty"`
	MaxSuccessCompletionGapMS                      int64                             `json:"max_success_completion_gap_ms,omitempty"`
	MaxSingleRequestLatencyMS                      int64                             `json:"max_single_request_latency_ms,omitempty"`
	...
	ProbeCanceledByStop                            int                               `json:"probe_canceled_by_stop,omitempty"`
	ProbeCanceledStartedBeforeStop                 int                               `json:"probe_canceled_started_before_stop,omitempty"`
	ProbeInflightAtStopCount                       int                               `json:"probe_inflight_at_stop_count,omitempty"`
	ProbeOldestInflightAgeAtStopMS                 int64                             `json:"probe_oldest_inflight_age_at_stop_ms,omitempty"`
	MissingRouteProofCount                         int                               `json:"missing_route_proof_count,omitempty"`
	ProbeSequence                                  int                               `json:"probe_sequence,omitempty"`
	MutationRequests                               int                               `json:"mutation_requests,omitempty"`
	MutationSuccesses                              int                               `json:"mutation_successes,omitempty"`
	MutationFailures                               int                               `json:"mutation_failures,omitempty"`
	MutationCanceledByStop                         int                               `json:"mutation_canceled_by_stop,omitempty"`
	MutationCanceledStartedBeforeStop              int                               `json:"mutation_canceled_started_before_stop,omitempty"`
	MutationInflightAtStopCount                    int                               `json:"mutation_inflight_at_stop_count,omitempty"`
	MutationOldestInflightAgeAtStopMS              int64                             `json:"mutation_oldest_inflight_age_at_stop_ms,omitempty"`
	MutationMaxAcceptedCounter                     int64                             `json:"mutation_max_accepted_counter,omitempty"`
	MutationDuplicateCount                         int                               `json:"mutation_duplicate_count,omitempty"`
	MutationLostAcceptedCount                      int                               `json:"mutation_lost_accepted_count,omitempty"`
	StateRegressed                                 bool                              `json:"state_regressed,omitempty"`
	MonotonicViolationCount                        int                               `json:"monotonic_violation_count,omitempty"`
	StaleVersionCount                              int                               `json:"stale_version_count,omitempty"`
	MissingStateProofCount                         int                               `json:"missing_state_proof_count,omitempty"`
	DualActiveObserved                             bool                              `json:"dual_active_observed,omitempty"`
	MigrationWindowResult                          string                            `json:"migration_window_result,omitempty"`
	MigrationWindowResourceResult                  string                            `json:"migration_window_resource_result,omitempty"`
	EndToEndResourceResult                         string                            `json:"end_to_end_resource_result,omitempty"`
	VerdictReason                                  string                            `json:"verdict_reason,omitempty"`
	CleanupIsolationDurationMS                     int64                             `json:"cleanup_isolation_duration_ms,omitempty"`
	CleanupIsolationProbeRequests                  int                               `json:"cleanup_isolation_probe_requests,omitempty"`
	CleanupIsolationProbeSuccesses                 int                               `json:"cleanup_isolation_probe_successes,omitempty"`
	ServiceErrorsDuringCleanup                     int                               `json:"service_errors_during_cleanup,omitempty"`
	RouteSwitchedProbeRequests                     int                               `json:"route_switched_probe_requests"`
	RouteSwitchedProbeSuccesses                    int                               `json:"route_switched_probe_successes"`
	ServiceErrorsDuringRouteSwitched               int                               `json:"service_errors_during_route_switched"`
	RouteTargetMismatchDuringRouteSwitched         int                               `json:"route_target_mismatch_during_route_switched"`
	MissingRouteProofDuringRouteSwitched           int                               `json:"missing_route_proof_during_route_switched"`
	MutationRouteSwitchedProbeRequests             int                               `json:"mutation_route_switched_probe_requests"`
	MutationRouteSwitchedProbeSuccesses            int                               `json:"mutation_route_switched_probe_successes"`
	MutationServiceErrorsDuringRouteSwitched       int                               `json:"mutation_service_errors_during_route_switched"`
	MutationRouteTargetMismatchDuringRouteSwitched int                               `json:"mutation_route_target_mismatch_during_route_switched"`
	MutationMissingRouteProofDuringRouteSwitched   int                               `json:"mutation_missing_route_proof_during_route_switched"`
	LiveMigrationDowntimeMS                        int64                             `json:"live_migration_downtime_ms,omitempty"`
	LiveMigrationConnections                       int                               `json:"live_migration_connections,omitempty"`
	LiveMigrationMemoryMode                        string                            `json:"live_migration_memory_mode,omitempty"`
	StreamEvents                                   int                               `json:"stream_events,omitempty"`
	StreamStartedBeforePrepare                     bool                              `json:"stream_started_before_prepare,omitempty"`
	StreamEventsBeforePrepare                      int                               `json:"stream_events_before_prepare,omitempty"`
	StreamDisconnects                              int                               `json:"stream_disconnects,omitempty"`
	StreamMaxMessageGapMS                          int64                             `json:"stream_max_message_gap_ms,omitempty"`
	StreamGapThresholdViolation                    bool                              `json:"stream_gap_threshold_violation,omitempty"`
	StreamSequenceGapCount                         int                               `json:"stream_sequence_gap_count,omitempty"`
	StreamDuplicateCount                           int                               `json:"stream_duplicate_count,omitempty"`
	StreamStateRegressionCount                     int                               `json:"stream_state_regression_count,omitempty"`
	StreamMaxGapPreviousFrame                      *StreamFrameEvidence              `json:"stream_max_gap_previous_frame,omitempty"`
	StreamMaxGapCurrentFrame                       *StreamFrameEvidence              `json:"stream_max_gap_current_frame,omitempty"`
	TerminalMessages                               int                               `json:"terminal_messages,omitempty"`
	TerminalStartedBeforePrepare                   bool                              `json:"terminal_started_before_prepare,omitempty"`
	TerminalTicks                                  int                               `json:"terminal_ticks,omitempty"`
	TerminalEchoes                                 int                               `json:"terminal_echoes,omitempty"`
	TerminalExpectedEchoes                         int                               `json:"terminal_expected_echoes,omitempty"`
	TerminalDisconnects                            int                               `json:"terminal_disconnects"`
	TerminalReconnectsObserved                     int                               `json:"terminal_reconnects_observed"`
	TerminalUXGapObserved                          bool                              `json:"terminal_ux_gap_observed"`
	TerminalMaxMessageGapMS                        int64                             `json:"terminal_max_message_gap_ms,omitempty"`
	TerminalMaxMessageGapStartOffsetMS             int64                             `json:"terminal_max_message_gap_start_offset_ms,omitempty"`
	TerminalMaxMessageGapEndOffsetMS               int64                             `json:"terminal_max_message_gap_end_offset_ms,omitempty"`
	TerminalEchoLatencyMaxMS                       int64                             `json:"terminal_echo_latency_max_ms"`
	TerminalEchoLatencyP95MS                       int64                             `json:"terminal_echo_latency_p95_ms"`
	TerminalEchoLatencyMaxSequence                 int                               `json:"terminal_echo_latency_max_sequence,omitempty"`
	TerminalEchoLatencyMaxSentOffsetMS             int64                             `json:"terminal_echo_latency_max_sent_offset_ms,omitempty"`
	TerminalEchoLatencyMaxReceivedOffsetMS         int64                             `json:"terminal_echo_latency_max_received_offset_ms,omitempty"`
	TerminalGapThresholdViolation                  bool                              `json:"terminal_gap_threshold_violation"`
	TerminalSequenceGapCount                       int                               `json:"terminal_sequence_gap_count"`
	TerminalDuplicateCount                         int                               `json:"terminal_duplicate_count"`
	TerminalMissingEchoCount                       int                               `json:"terminal_missing_echo_count"`
	TerminalMissingEchoSequences                   []int                             `json:"terminal_missing_echo_sequences,omitempty"`
	TerminalMissingEchoSentOffsetsMS               []int64                           `json:"terminal_missing_echo_sent_offsets_ms,omitempty"`
	TerminalFirstMissingEchoSequence               int                               `json:"terminal_first_missing_echo_sequence,omitempty"`
	TerminalLastMissingEchoSequence                int                               `json:"terminal_last_missing_echo_sequence,omitempty"`
	TerminalPIDChanged                             bool                              `json:"terminal_pid_changed"`
	TerminalStateRegressionCount                   int                               `json:"terminal_state_regression_count"`
	TerminalContinuityResult                       string                            `json:"terminal_continuity_result,omitempty"`
	TerminalUXResult                               string                            `json:"terminal_ux_result,omitempty"`
	TerminalMaxGapPreviousFrame                    *TerminalFrameEvidence            `json:"terminal_max_gap_previous_frame,omitempty"`
	TerminalMaxGapCurrentFrame                     *TerminalFrameEvidence            `json:"terminal_max_gap_current_frame,omitempty"`
	TerminalEchoLatencyMaxFrame                    *TerminalFrameEvidence            `json:"terminal_echo_latency_max_frame,omitempty"`
	TerminalStateRegressionSamples                 []TerminalStateRegressionEvidence `json:"terminal_state_regression_samples,omitempty"`
}

type StreamFrameEvidence struct {
	ReceivedOffsetMS int64  `json:"received_offset_ms,omitempty"`
	...
	ServerUnixNano   int64  `json:"server_unix_nano,omitempty"`
}

type TerminalFrameEvidence struct {
	ReceivedOffsetMS         int64  `json:"received_offset_ms,omitempty"`
	Type                     string `json:"type,omitempty"`
	TerminalSequence         int64  `json:"terminal_sequence,omitempty"`
	...
	ClientUnixNano           int64  `json:"client_unix_nano,omitempty"`
	ServerUnixNano           int64  `json:"server_unix_nano,omitempty"`
	ServerReadUnixNano       int64  `json:"server_read_unix_nano,omitempty"`
	ServerEnqueueUnixNano    int64  `json:"server_enqueue_unix_nano,omitempty"`
	ServerWriteStartUnixNano int64  `json:"server_write_start_unix_nano,omitempty"`
	ServerWriteEndUnixNano   int64  `json:"server_write_end_unix_nano,omitempty"`
}

type TerminalStateRegressionEvidence struct {
	Previous TerminalFrameEvidence `json:"previous"`
	Current  TerminalFrameEvidence `json:"current"`
}
