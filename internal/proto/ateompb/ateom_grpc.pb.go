...
const (
	...
	Ateom_ReceiveLiveMigration_FullMethodName = "/ateom.Ateom/ReceiveLiveMigration"
	Ateom_SendLiveMigration_FullMethodName    = "/ateom.Ateom/SendLiveMigration"
)
...
type AteomClient interface {
	...
	// ReceiveLiveMigration prepares a destination microVM and blocks until Cloud
	// Hypervisor receives an inbound live migration.
	...
	// SendLiveMigration asks the currently running microVM to migrate to a
...
func (c *ateomClient) ReceiveLiveMigration(ctx context.Context, in *ReceiveLiveMigrationRequest, opts ...grpc.CallOption) (*ReceiveLiveMigrationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReceiveLiveMigrationResponse)
	err := c.cc.Invoke(ctx, Ateom_ReceiveLiveMigration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ateomClient) SendLiveMigration(ctx context.Context, in *SendLiveMigrationRequest, opts ...grpc.CallOption) (*SendLiveMigrationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendLiveMigrationResponse)
	err := c.cc.Invoke(ctx, Ateom_SendLiveMigration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAteomServer) ReceiveLiveMigration(context.Context, *ReceiveLiveMigrationRequest) (*ReceiveLiveMigrationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReceiveLiveMigration not implemented")
}
func (UnimplementedAteomServer) SendLiveMigration(context.Context, *SendLiveMigrationRequest) (*SendLiveMigrationResponse, error) {
...
func _Ateom_ReceiveLiveMigration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReceiveLiveMigrationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AteomServer).ReceiveLiveMigration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ateom_ReceiveLiveMigration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AteomServer).ReceiveLiveMigration(ctx, req.(*ReceiveLiveMigrationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Ateom_SendLiveMigration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendLiveMigrationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AteomServer).SendLiveMigration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ateom_SendLiveMigration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AteomServer).SendLiveMigration(ctx, req.(*SendLiveMigrationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Ateom_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Ateom_ReceiveLiveMigration_Handler,
		},
		{
			MethodName: "SendLiveMigration",
			Handler:    _Ateom_SendLiveMigration_Handler,
		},
	},
