...
func (SnapshotScope) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_proto_ateompb_ateom_proto_enumTypes[0].Descriptor()
}

func (SnapshotScope) Type() protoreflect.EnumType {
	return &file_internal_proto_ateompb_ateom_proto_enumTypes[0]
}
...
func (x *RestoreWorkloadRequest) Reset() {
	*x = RestoreWorkloadRequest{}
	mi := &file_internal_proto_ateompb_ateom_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RestoreWorkloadRequest) Descriptor() ([]byte, []int) {
	return file_internal_proto_ateompb_ateom_proto_rawDescGZIP(), []int{8}
}
...
func (x *RestoreWorkloadResponse) Reset() {
	*x = RestoreWorkloadResponse{}
	mi := &file_internal_proto_ateompb_ateom_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RestoreWorkloadResponse) Descriptor() ([]byte, []int) {
	return file_internal_proto_ateompb_ateom_proto_rawDescGZIP(), []int{9}
}
...
const file_internal_proto_ateompb_ateom_proto_rawDesc = "" +
	"\n" +
	"\"internal/proto/ateompb/ateom.proto\x12\x05ateom\"\xa9\x03\n" +
...
var file_internal_proto_ateompb_ateom_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_internal_proto_ateompb_ateom_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
...
func file_internal_proto_ateompb_ateom_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_internal_proto_ateompb_ateom_proto_enumTypes,
