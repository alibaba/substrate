...
type CheckpointRequest struct {
	...
	// If true, the runtime should resume the workload after capturing the
	// checkpoint and atelet must not reset the actor's live directories.
	PreserveRunning bool `protobuf:"varint,11,opt,name=preserve_running,json=preserveRunning,proto3" json:"preserve_running,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *CheckpointRequest) GetPreserveRunning() bool {
	if x != nil {
...
type CheckpointResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// True when atelet atomically published a decoded node-local cache entry for
	// this external snapshot. The external snapshot remains the source of truth.
	LocalCachePublished bool `protobuf:"varint,1,opt,name=local_cache_published,json=localCachePublished,proto3" json:"local_cache_published,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *CheckpointResponse) GetLocalCachePublished() bool {
	if x != nil {
		return x.LocalCachePublished
	}
	return false
}
...
type ReceiveLiveMigrationRequest struct {
	...
	Spec                   *WorkloadSpec          `protobuf:"bytes,6,opt,name=spec,proto3" json:"spec,omitempty"`
	SandboxAssets          *SandboxAssets         `protobuf:"bytes,7,opt,name=sandbox_assets,json=sandboxAssets,proto3" json:"sandbox_assets,omitempty"`
	ReceiverUrl            string                 `protobuf:"bytes,8,opt,name=receiver_url,json=receiverUrl,proto3" json:"receiver_url,omitempty"`
	MemoryMode             string                 `protobuf:"bytes,9,opt,name=memory_mode,json=memoryMode,proto3" json:"memory_mode,omitempty"`
	TlsDir                 string                 `protobuf:"bytes,10,opt,name=tls_dir,json=tlsDir,proto3" json:"tls_dir,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *ReceiveLiveMigrationRequest) GetTargetAteomUid() string {
	if x != nil {
		return x.TargetAteomUid
	}
	return ""
...
func (x *ReceiveLiveMigrationRequest) GetSandboxAssets() *SandboxAssets {
	if x != nil {
		return x.SandboxAssets
	}
	return nil
...
type SendLiveMigrationRequest struct {
	...
	TimeoutS        int64                  `protobuf:"varint,5,opt,name=timeout_s,json=timeoutS,proto3" json:"timeout_s,omitempty"`
	TimeoutStrategy string                 `protobuf:"bytes,6,opt,name=timeout_strategy,json=timeoutStrategy,proto3" json:"timeout_strategy,omitempty"`
	Connections     int64                  `protobuf:"varint,7,opt,name=connections,proto3" json:"connections,omitempty"`
...
func (x *SendLiveMigrationRequest) GetTargetAteomUid() string {
	if x != nil {
		return x.TargetAteomUid
	}
	return ""
...
const file_atelet_proto_rawDesc = "" +
	...
	"\x13snapshot_uri_prefix\x18\x01 \x01(\tR\x11snapshotUriPrefix\"\xb9\x04\n" +
	...
	"\x10preserve_running\x18\v \x01(\bR\x0fpreserveRunningB\b\n" +
	"\x06config\"H\n" +
	"\x12CheckpointResponse\x122\n" +
	"\x15local_cache_published\x18\x01 \x01(\bR\x13localCachePublished\"\x8b\x04\n" +
	...
	"\x06config\"\x11\n" +
	"\x0fRestoreResponse\"\xb1\x03\n" +
	"\x1bReceiveLiveMigrationRequest\x12(\n" +
	"\x10target_ateom_uid\x18\x01 \x01(\tR\x0etargetAteomUid\x12\x1a\n" +
	"\batespace\x18\x02 \x01(\tR\batespace\x12\x1d\n" +
	"\n" +
	"actor_name\x18\x03 \x01(\tR\tactorName\x128\n" +
	...
	"\freceiver_url\x18\b \x01(\tR\vreceiverUrl\x12\x1f\n" +
	"\vmemory_mode\x18\t \x01(\tR\n" +
	"memoryMode\x12\x17\n" +
	"\atls_dir\x18\n" +
	" \x01(\tR\x06tlsDir\"\x1e\n" +
	"\x1cReceiveLiveMigrationResponse\"\xd1\x02\n" +
	"\x18SendLiveMigrationRequest\x12(\n" +
	"\x10target_ateom_uid\x18\x01 \x01(\tR\x0etargetAteomUid\x12\x1d\n" +
	"\n" +
	"actor_name\x18\x02 \x01(\tR\tactorName\x12'\n" +
	"\x0fdestination_url\x18\x03 \x01(\tR\x0edestinationUrl\x12\x1f\n" +
	"\vdowntime_ms\x18\x04 \x01(\x03R\n" +
	"downtimeMs\x12\x1b\n" +
	"\ttimeout_s\x18\x05 \x01(\x03R\btimeoutS\x12)\n" +
	"\x10timeout_strategy\x18\x06 \x01(\tR\x0ftimeoutStrategy\x12 \n" +
	"\vconnections\x18\a \x01(\x03R\vconnections\x12\x1f\n" +
	"\vmemory_mode\x18\b \x01(\tR\n" +
	"memoryMode\x12\x17\n" +
	"\atls_dir\x18\t \x01(\tR\x06tlsDir\"\x1b\n" +
	"\x19SendLiveMigrationResponse*F\n" +
	"\n" +
	"VolumeType\x12\x1b\n" +
	...
	"\x13SNAPSHOT_SCOPE_DATA\x10\x022\x85\x03\n" +
	"\vAteomHerder\x120\n" +
	...
	"\aRestore\x12\x16.atelet.RestoreRequest\x1a\x17.atelet.RestoreResponse\"\x00\x12c\n" +
	"\x14ReceiveLiveMigration\x12#.atelet.ReceiveLiveMigrationRequest\x1a$.atelet.ReceiveLiveMigrationResponse\"\x00\x12Z\n" +
	"\x11SendLiveMigration\x12 .atelet.SendLiveMigrationRequest\x1a!.atelet.SendLiveMigrationResponse\"\x00B>Z<github.com/agent-substrate/substrate/internal/proto/ateletpbb\x06proto3"
...
var file_atelet_proto_goTypes = []any{
	...
	(*ReceiveLiveMigrationRequest)(nil),     // 22: atelet.ReceiveLiveMigrationRequest
	(*ReceiveLiveMigrationResponse)(nil),    // 23: atelet.ReceiveLiveMigrationResponse
	(*SendLiveMigrationRequest)(nil),        // 24: atelet.SendLiveMigrationRequest
	(*SendLiveMigrationResponse)(nil),       // 25: atelet.SendLiveMigrationResponse
...
var file_atelet_proto_depIdxs = []int32{
	...
	26, // 2: atelet.ArchAssets.files:type_name -> atelet.ArchAssets.FilesEntry
	27, // 3: atelet.SandboxAssets.assets:type_name -> atelet.SandboxAssets.AssetsEntry
	...
	7,  // 22: atelet.ReceiveLiveMigrationRequest.spec:type_name -> atelet.WorkloadSpec
	6,  // 23: atelet.ReceiveLiveMigrationRequest.sandbox_assets:type_name -> atelet.SandboxAssets
	...
	18, // 27: atelet.AteomHerder.Checkpoint:input_type -> atelet.CheckpointRequest
	20, // 28: atelet.AteomHerder.Restore:input_type -> atelet.RestoreRequest
	22, // 29: atelet.AteomHerder.ReceiveLiveMigration:input_type -> atelet.ReceiveLiveMigrationRequest
	24, // 30: atelet.AteomHerder.SendLiveMigration:input_type -> atelet.SendLiveMigrationRequest
	15, // 31: atelet.AteomHerder.Run:output_type -> atelet.RunResponse
	19, // 32: atelet.AteomHerder.Checkpoint:output_type -> atelet.CheckpointResponse
	21, // 33: atelet.AteomHerder.Restore:output_type -> atelet.RestoreResponse
	23, // 34: atelet.AteomHerder.ReceiveLiveMigration:output_type -> atelet.ReceiveLiveMigrationResponse
	25, // 35: atelet.AteomHerder.SendLiveMigration:output_type -> atelet.SendLiveMigrationResponse
